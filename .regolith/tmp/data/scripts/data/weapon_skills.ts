...
const weaponSkills: SkillHandler[] = [solarisverdantSkill, superchargedCopperAxeSkill, prismWeaverSkill, auricPhotonizerSkill, theBleedingSpireSkill];
export { weaponSkills }
